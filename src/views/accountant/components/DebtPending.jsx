          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-navy-700">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-navy-700 dark:text-white">Debt Date</th>
              ...
              {transactions.map((transaction) => (
                ...
                >
                  <td className="py-3 px-4 text-sm text-navy-700 dark:text-white">
                    {`ID${transaction.id.toString().padStart(4, '0')}`}
                  </td>
                  <td className="py-3 px-4 text-sm text-navy-700 dark:text-white">
                    {transaction.student}
                  </td>
