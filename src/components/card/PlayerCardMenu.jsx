...
import AddPlayer from "../../views/admin/form/AddPlayer"; // Import AddStudent component
...
function CardMenu(props) {
  ...
  const [isAddPlayerModalOpen, setIsAddPlayerModalOpen] = useState(false); // For AddStudent modal
  ...
  const handleCloseAddPlayerModal = () => setIsAddPlayerModalOpen(false);
  ...
  return (
    <div>
      ...
      <Dropdown
        ...
        children={
          <div className="z-50 w-max rounded-xl bg-white py-3 px-4 text-sm shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
            ...
            <p
              onClick={handleOpenAddPlayerModal} // Open AddStudent modal
      ...
      {isAddPlayerModalOpen && (
        <AddPlayer isOpen={isAddPlayerModalOpen} onClose={handleCloseAddPlayerModal} />
      )}
